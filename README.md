...
施行条件を選ぶと、過去3年の騎手・厩舎について勝利数上位と勝率上位を表示するブラウザアプリです。
...
現在同梱しているデータは10,343レース、141,394出走分です。
期間は2023年5月20日から2026年5月16日までです。
...
```csv
date,course,surface,distance,race,finish,horseNumber,horse,jockey,trainer,winPayout
2026-02-08,東京,芝,1600,11,1,5,サンプルホース,C.ルメール,木村哲也,320
2026-02-08,東京,芝,1600,11,2,3,サンプルホース2,川田将雅,中内田充正,0
```
...
```text
東京 22,327 / 京都 22,607 / 中山 21,777 / 阪神 15,512 / 中京 13,491
新潟 13,057 / 小倉 10,782 / 福島 10,207 / 札幌 6,334 / 函館 5,300
```
